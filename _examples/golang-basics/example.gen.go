// example v0.0.1 388b5585cc00538cd2898bc666a664585923c3d1
// --
...
func WebRPCSchemaHash() string {
	return "388b5585cc00538cd2898bc666a664585923c3d1"
}
...
type exampleServiceServer struct {
	ExampleService
	SendErrorJSON func(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError)
}

func NewExampleServiceServer(svc ExampleService) *exampleServiceServer {
	return &exampleServiceServer{
		ExampleService: svc,
		SendErrorJSON:  errorJSON,
	}
}
...
func oldRespondWithError(w http.ResponseWriter, err error) {
	rpcErr, ok := err.(WebRPCError)
	if !ok {
		rpcErr = ErrWebrpcEndpoint.WithCause(err)
	}
...
func errorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(rpcErr.HTTPStatus)
