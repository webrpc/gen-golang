// example v0.0.1 b4d44f455f305e12df7ff92cc7e00d91ca2d98a3
// --
// Code generated by webrpc-gen@v0.36.2-0.20260321072159-3267f049abfb with ../../../gen-golang generator. DO NOT EDIT.
//
...
func WebRPCSchemaHash() string {
	return "b4d44f455f305e12df7ff92cc7e00d91ca2d98a3"
}
...
type ExampleClient interface {
	...
	StreamNewArticles(ctx context.Context, streamNewArticlesRequest StreamNewArticlesRequest) (StreamNewArticlesStreamReader, error)
}
...
type ExampleServer interface {
	...
	GetArticle(ctx context.Context, getArticleRequest GetArticleRequest) (*GetArticleResponse, error)
	// Streaming article endpoint
	StreamNewArticles(ctx context.Context, streamNewArticlesRequest StreamNewArticlesRequest, stream StreamNewArticlesStreamWriter) error
}
...
// TxHash and Address demonstrate go.type / go.alias pulling a custom Go type
// from a package local to this repository (golang-basics/hash), rather than
// a third-party module.

type TxHash hash.Hash
...
const (
	...
	AuditActorTypeAPIKey      AuditActorType = "apiKey"
...
var AuditActorType_values = []AuditActorType{
	AuditActorTypeService,
	AuditActorTypeAPIKey,
	AuditActorTypeExternalURL,
	AuditActorTypeResourceID,
	AuditActorTypeHTTPRequest,
}

func (x AuditActorType) MarshalText() ([]byte, error) {
	return []byte(x), nil
}

func (x *AuditActorType) UnmarshalText(b []byte) error {
	*x = AuditActorType(string(b))
	return nil
}

func (x *AuditActorType) Is(values ...AuditActorType) bool {
	if x == nil {
		return false
	}
	for _, v := range values {
...
func (c *exampleClient) StreamNewArticles(ctx context.Context, streamNewArticlesRequest StreamNewArticlesRequest) (StreamNewArticlesStreamReader, error) {
	resp, err := doHTTPRequestRaw(ctx, c.client, c.urls[7], streamNewArticlesRequest, nil)
	if err != nil {
		if resp != nil {
			resp.Body.Close()
		}
...
func (s *exampleService) serveGetUserJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	ret0, err := s.ExampleServer.GetUser(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *exampleService) serveStreamNewArticlesJSONStream(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	reqPayload := StreamNewArticlesRequest{}
	if err := jsonCfg.Unmarshal(reqBody, &reqPayload); err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCausef("failed to unmarshal request data: %w", err))
		return
	}
	...
	// Call service method implementation.
	if err := s.ExampleServer.StreamNewArticles(ctx, reqPayload, streamWriter); err != nil {
		cancel()
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
const WebrpcHeaderValue = "webrpc@v0.36.2-0.20260321072159-3267f049abfb;gen-golang@unknown;example@v0.0.1"
