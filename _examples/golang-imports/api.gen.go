...
const WebrpcHeaderValue = "webrpc@v0.28.2;gen-golang@unknown;example-api-service@v1.0.0"
...
func (c *exampleAPIClient) Status(ctx context.Context) (bool, error) {out := struct {
		Ret0 bool `json:"status"`
	}{}
...
func (c *exampleAPIClient) GetUsers(ctx context.Context) ([]*User, Location, error) {out := struct {
		Ret0 []*User `json:"users"`
		Ret1 Location `json:"location"`
	}{}
